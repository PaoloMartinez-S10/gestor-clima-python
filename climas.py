...
def mostrar_estadisticas(datos):
    ...
    print("\n--- REPORTE CLIMÁTICO --- ")
    print(f"Ciudad más calurosa (Media): {ciudad_mas_caliente['ciudad']} ({ciudad_mas_caliente['media']}°C)")
    print(f" Ciudad más fría (Mínima):    {ciudad_mas_fria['ciudad']} ({ciudad_mas_fria['minima']}°C)")
